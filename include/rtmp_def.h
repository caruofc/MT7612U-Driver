...
/* AP won't spend more than 1/4 of total buffers on M/BCAST PSQ */
/* #define MAX_SIZE_OF_MCAST_PSQ (NUM_OF_LOCAL_TXBUF >> 2) */
...
/* Indicate driver should IMMEDIATELY fo to sleep after receiving AP's beacon in which
* doesn't indicate unicate nor multicast packets for me
...
/* CLIENT can receive Ralink's proprietary TX aggregation frame */
...
/*#define IsGroupKeyWCID(__pAd, __wcid) (((__wcid) < LAST_SPECIFIC_WCID) &&
* ((__wcid) >= (LAST_SPECIFIC_WCID - (MAX_MBSSID_NUM(__pAd)))))
*/
...
#define MAX_NUM_OF_11JCHANNELS   20  /* 14 channels @2.4G +  12@UNII + 4 @MMAC + 11 @HiperLAN2 +
						* 7 @Japan + 1 as NULL termination
						*/
...
#else
/* if MAX_MBSSID_NUM is 8, this value can't be larger than 211 */
...
/* (NUM_OF_TID*MAX_AID_BA + 32)  Block ACK recipient */
#define MAX_LEN_OF_BA_REC_TABLE       ((NUM_OF_TID * MAX_LEN_OF_MAC_TABLE)/2)
/* (NUM_OF_TID*MAX_AID_BA + 32) Block ACK originator */
...
/* Indicate the maximum category code defined in IEEE-802.11-Std */
#define MAX_IEEE_STD_CATE	21
...
#define BW_10		BAND_WIDTH_10	/* 802.11j has 10MHz. This definition is for internal usage.
					* doesn't fill in the IE or other field.
					*/
...
#define REGION_IDX_CERTIFICATION          127
...
#define REGION_CERT_BG_BAND               REGION_IDX_CERTIFICATION
...
#define REGION_1_A_BAND                   1	/* 36, 40, 44, 48, 52, 56, 60, 64, 100, 104,
...
#define REGION_7_A_BAND                   7	/* 36, 40, 44, 48, 52, 56, 60, 64, 100, 104,
						* 108, 112, 116, 120, 124, 128, 132, 136,
						* 140, 149, 153, 157, 161, 165, 169, 173
						*/
#define REGION_8_A_BAND                   8	/* 52, 56, 60, 64 */
#define REGION_9_A_BAND                   9	/* 36, 40, 44, 48, 52, 56, 60, 64, 100, 104, 108,
						* 112, 116, 132, 136, 140, 149, 153, 157, 161, 165
						*/
#define REGION_10_A_BAND                  10	/* 36, 40, 44, 48, 149, 153, 157, 161, 165 */
#define REGION_11_A_BAND                  11	/* 36, 40, 44, 48, 52, 56, 60, 64, 100, 104,
						* 108, 112, 116, 120, 149, 153, 157, 161
						*/
#define REGION_12_A_BAND                  12	/* 36, 40, 44, 48, 52, 56, 60, 64, 100, 104,
						* 108, 112, 116, 120, 124, 128, 132, 136, 140
						*/
#define REGION_13_A_BAND                  13	/* 52, 56, 60, 64, 100, 104, 108, 112, 116, 120,
						* 124, 128, 132, 136, 140, 149, 153, 157, 161
						*/
#define REGION_14_A_BAND                  14	/* 36, 40, 44, 48, 52, 56, 60, 64, 100, 104, 108,
...
#define REGION_CERT_A_BAND                REGION_IDX_CERTIFICATION
#ifdef CUSTOMIZED_COUNTRY_REGION_CE_1
...
#define EVENT_AGED_OUT              3	/* Log = "hh:mm:ss   STA 00:01:02:03:04:05 was
					* aged-out and removed from this BSS"
					*/
...
#define RD_SILENCE_MODE		                2    /* After channel switch, need to be silence a
						       * while to ensure radar not found
							*/
...
#define RTMP_OS_TASK_INIT(__pTask, __pTaskName, __pAd)		\
	...
	&(__pAd)->RscTaskMemList, &(__pAd)->RscSemMemList)
