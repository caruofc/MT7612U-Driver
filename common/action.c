...
{
	/*APBssScan.DelayFactor[1] * 256 + APBssScan.DelayFactor[0]; */
	pAd->CommonCfg.Dot11BssWidthChanTranDelayFactor = le2cpu16(APBssScan.DelayFactor);
	...
	if ((pAd->CommonCfg.Dot11BssWidthChanTranDelayFactor < 5)
		...
		/*DBGPRINT(RT_DEBUG_ERROR,("ACT - UpdateBssScanParm( Dot11BssWidthChanTranDelayFactor
			out of range !!!!)\n")); */
		pAd->CommonCfg.Dot11BssWidthChanTranDelayFactor = 5;
	}

	/*APBssScan.TriggerScanInt[1] * 256 + APBssScan.TriggerScanInt[0]; */
	pAd->CommonCfg.Dot11BssWidthTriggerScanInt = le2cpu16(APBssScan.TriggerScanInt);
	/* out of range defined in MIB... So fall back to default value. */
	if ((pAd->CommonCfg.Dot11BssWidthTriggerScanInt < 10)
	    || (pAd->CommonCfg.Dot11BssWidthTriggerScanInt > 900)) {
		/*DBGPRINT(RT_DEBUG_ERROR,("ACT - UpdateBssScanParm( Dot11BssWidthTriggerScanInt
			out of range !!!!)\n")); */
		pAd->CommonCfg.Dot11BssWidthTriggerScanInt = 900;
	}

	/*APBssScan.ScanPassiveDwell[1] * 256 + APBssScan.ScanPassiveDwell[0]; */
	pAd->CommonCfg.Dot11OBssScanPassiveDwell = le2cpu16(APBssScan.ScanPassiveDwell);
	/* out of range defined in MIB... So fall back to default value. */
	if ((pAd->CommonCfg.Dot11OBssScanPassiveDwell < 5)
	    || (pAd->CommonCfg.Dot11OBssScanPassiveDwell > 1000)) {
		/*DBGPRINT(RT_DEBUG_ERROR,("ACT - UpdateBssScanParm( Dot11OBssScanPassiveDwell
			out of range !!!!)\n")); */
		pAd->CommonCfg.Dot11OBssScanPassiveDwell = 20;
	}

	/*APBssScan.ScanActiveDwell[1] * 256 + APBssScan.ScanActiveDwell[0]; */
	pAd->CommonCfg.Dot11OBssScanActiveDwell = le2cpu16(APBssScan.ScanActiveDwell);
	/* out of range defined in MIB... So fall back to default value. */
	if ((pAd->CommonCfg.Dot11OBssScanActiveDwell < 10)
	    || (pAd->CommonCfg.Dot11OBssScanActiveDwell > 1000)) {
		/*DBGPRINT(RT_DEBUG_ERROR,("ACT - UpdateBssScanParm( Dot11OBssScanActiveDwell
			out of range !!!!)\n")); */
		pAd->CommonCfg.Dot11OBssScanActiveDwell = 10;
	}

	/*APBssScan.PassiveTalPerChannel[1] * 256 + APBssScan.PassiveTalPerChannel[0]; */
	pAd->CommonCfg.Dot11OBssScanPassiveTotalPerChannel = le2cpu16(APBssScan.PassiveTalPerChannel);
	/* out of range defined in MIB... So fall back to default value. */
	if ((pAd->CommonCfg.Dot11OBssScanPassiveTotalPerChannel < 200)
	    || (pAd->CommonCfg.Dot11OBssScanPassiveTotalPerChannel > 10000)) {
		/*DBGPRINT(RT_DEBUG_ERROR,("ACT - UpdateBssScanParm(Dot11OBssScanPassiveTotalPerChannel
			out of range !!!!)\n")); */
		pAd->CommonCfg.Dot11OBssScanPassiveTotalPerChannel = 200;
	}

	/*APBssScan.ActiveTalPerChannel[1] * 256 + APBssScan.ActiveTalPerChannel[0]; */
	pAd->CommonCfg.Dot11OBssScanActiveTotalPerChannel = le2cpu16(APBssScan.ActiveTalPerChannel);
	/* out of range defined in MIB... So fall back to default value. */
	if ((pAd->CommonCfg.Dot11OBssScanActiveTotalPerChannel < 20)
	    || (pAd->CommonCfg.Dot11OBssScanActiveTotalPerChannel > 10000)) {
		/*DBGPRINT(RT_DEBUG_ERROR,("ACT - UpdateBssScanParm(
			Dot11OBssScanActiveTotalPerChannel out of range !!!!)\n")); */
		pAd->CommonCfg.Dot11OBssScanActiveTotalPerChannel = 20;
	}

	/*APBssScan.ScanActThre[1] * 256 + APBssScan.ScanActThre[0]; */
	pAd->CommonCfg.Dot11OBssScanActivityThre = le2cpu16(APBssScan.ScanActThre);
	/* out of range defined in MIB... So fall back to default value. */
	...
	case ACTION_BSS_2040_COEXIST:	/* Format defined in IEEE 7.4.7a.1 in 11n Draf3.03 */
		{
			...
			/* hex_dump("IntolerantReport ", (PUCHAR)pIntolerantReport,
			   sizeof(BSS_2040_INTOLERANT_CH_REPORT)); */
				...
				if (!IS_ENTRY_APCLI(&pAd->MacTab.Content[Elem->Wcid])) {
					...
					if ((pBssCoexistIe->field.BSS20WidthReq == 1)
						...
						DBGPRINT(RT_DEBUG_TRACE,
						   ...
						   /*&& (pIntolerantReport->RegulatoryClass
...
VOID PeerHTAction(RTMP_ADAPTER *pAd, MLME_QUEUE_ELEM *Elem)
{
	...
	case NOTIFY_BW_ACTION:
		...
		if (pAd->StaActive.SupportedPhyInfo.bHtEnable == FALSE) {
			/* Note, this is to patch DIR-1353 AP. When the AP set to Wep, it will use legacy mode.
			 * But AP still keeps */
