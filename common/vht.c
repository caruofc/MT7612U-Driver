		...
		if (IS_MT76x2(pAd)) {
			vht_op.basic_mcs_set.mcs_ss2 = (((pAd->CommonCfg.vht_bw == VHT_BW_2040)
							 && (pAd->CommonCfg.RegTransmitSetting.
							     ...
							     BW_20)) ? VHT_MCS_CAP_8 :
							VHT_MCS_CAP_9);
			DBGPRINT(RT_DEBUG_TRACE, ("2SS vht_op.basic_mcs_set.mcs_ss2: %d",
...
INT build_vht_cap_ie(RTMP_ADAPTER *pAd, UCHAR *buf)
{
	...
	/* TODO: Ask Jerry about the hardware limitation, currently set as 64K */
	vht_cap_ie.vht_cap.max_ampdu_exp = 3;
